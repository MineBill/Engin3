...
INCLUDE_STANDARD_BOOL :: #config(NK_INCLUDE_STANDARD_BOOL, true)

when INCLUDE_STANDARD_BOOL do Bool :: b32
else do Bool :: b8
...
foreign nuklear
{
    when NK_INCLUDE_DEFAULT_ALLOCATOR
    {
        /*
        // #### nk_init_default
    ...
    */
    input_key :: proc(ctx: ^Context, keys: Keys, down: Bool) ---
    ...
    // __down__    | Must be 0 for key is up and 1 for key is down
    */
    input_button :: proc(ctx: ^Context, btn: Buttons, x, y: i32, down: Bool) ---
    ...
    */
    ...
    Returns `true(1)` if visible and fillable with widgets or `false(0)` otherwise
    */
    tree_push_hashed :: proc(ctx: ^Context, Tree_Type, title: cstring, initial_state: Collapse_States, hash: cstring, len, seed: i32) -> Bool ---
    ...
    */
    ...
    button_text :: proc(ctx: ^Context, title: cstring, len: i32) -> Bool ---
    ...
    selectable_label :: proc(ctx: ^Context, label: cstring, align: Flags, value: ^Bool) -> Bool ---
    ...
    select_text :: proc(ctx: ^Context, label: cstring, i32, align: Flags, value: ^Bool) -> Bool ---
    ...
    */
    ...
    popup_begin :: proc(ctx: ^Context, type: Popup_Type, name: cstring, flags: Flags, bounds: Rect) -> Bool ---
    ...
    combo_item_label :: proc(ctx: ^Context, text: cstring, alignment: Flags) -> Bool ---
    ...
    menu_begin_label :: proc(ctx: ^Context, str: cstring, align: Flags, size: Vec2) -> Bool ---
...
INCLUDE_FONT_BAKING :: true
INCLUDE_DEFAULT_ALLOCATOR :: NK_INCLUDE_DEFAULT_ALLOCATOR
...
button_string :: #force_inline proc(ctx: ^Context, name: string) -> bool {
    return bool(button_text(ctx, strings.unsafe_string_to_cstring(name), i32(len(name))))
}
