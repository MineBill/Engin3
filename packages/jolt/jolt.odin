...
foreign Jolt {
	...
	MotionProperties_GetLinearVelocity :: proc(in_properties:^MotionProperties,out_linear_velocity:^[3]c.float)---
	...
	MotionProperties_GetAngularVelocity :: proc(in_properties:^MotionProperties,out_angular_velocity:^[3]c.float)---
	...
	MotionProperties_GetInverseInertiaDiagonal :: proc(in_properties:^MotionProperties,out_inverse_inertia_diagonal:^[3]c.float)---
	MotionProperties_GetInertiaRotation :: proc(in_properties:^MotionProperties,out_inertia_rotation:^[4]c.float)---
	MotionProperties_SetInverseInertia :: proc(in_properties:^MotionProperties,in_diagonal:^[3]c.float,in_rotation:^[4]c.float)---
	MotionProperties_GetLocalSpaceInverseInertia :: proc(in_properties:^MotionProperties,out_matrix:^[16]c.float)---
	MotionProperties_GetInverseInertiaForRotation :: proc(in_properties:^MotionProperties,in_rotation_matrix:^[16]c.float,out_matrix:^[16]c.float)---
	MotionProperties_MultiplyWorldSpaceInverseInertiaByVector :: proc(in_properties:^MotionProperties,in_body_rotation:^[4]c.float,in_vector:^[3]c.float,out_vector:^[3]c.float)---
	MotionProperties_GetPointVelocityCOM :: proc(in_properties:^MotionProperties,in_point_relative_to_com:^[3]c.float,out_point:^[3]c.float)---
	...
	Body_GetLinearVelocity :: proc(in_body:^Body,out_linear_velocity:^[3]c.float)---
	...
	Body_GetAngularVelocity :: proc(in_body:^Body,out_angular_velocity:^[3]c.float)---
	...
	Body_GetPointVelocityCOM :: proc(in_body:^Body,in_point_relative_to_com:^[3]c.float,out_velocity:^[3]c.float)---
	Body_GetPointVelocity :: proc(in_body:^Body,in_point:^[3]c.float,out_velocity:^[3]c.float)---
	...
	Body_GetInverseInertia :: proc(in_body:^Body,out_inverse_inertia:^[16]c.float)---
	...
	Body_GetPosition :: proc(in_body:^Body,out_position:^[3]c.float)---
	Body_GetRotation :: proc(in_body:^Body,out_rotation:^[4]c.float)---
	Body_GetWorldTransform :: proc(in_body:^Body,out_rotation:^[9]c.float,out_translation:^[3]c.float)---
	Body_GetCenterOfMassPosition :: proc(in_body:^Body,out_position:^[3]c.float)---
	Body_GetCenterOfMassTransform :: proc(in_body:^Body,out_rotation:^[9]c.float,out_translation:^[3]c.float)---
	Body_GetInverseCenterOfMassTransform :: proc(in_body:^Body,out_rotation:^[9]c.float,out_translation:^[3]c.float)---
	Body_GetWorldSpaceBounds :: proc(in_body:^Body,out_min:^[3]c.float,out_max:^[3]c.float)---
	...
	Body_GetWorldSpaceSurfaceNormal :: proc(in_body:^Body,in_sub_shape_id:SubShapeID,in_position:^[3]c.float,out_normal_vector:^[3]c.float)---
	...
	Character_Create :: proc(in_settings:^CharacterSettings,in_position:^[3]c.float,in_rotation:^[4]c.float,in_user_data:c.uint64_t,in_physics_system:^PhysicsSystem) -> ^Character---
	...
	CharacterVirtual_Create :: proc(in_settings:^CharacterVirtualSettings,in_position:^[3]c.float,in_rotation:^[4]c.float,in_physics_system:^PhysicsSystem) -> ^CharacterVirtual---
