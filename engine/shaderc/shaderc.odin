...
when ODIN_OS == .Windows {
	...
	foreign import libshaderc "shaderc_combined.lib"
...
foreign libshaderc {
	...
	compile_options_set_target_env :: proc(options: ^CompileOptions, target: TargetEnv, version: u32) ---
	...
	compile_into_spv :: proc(compiler: ^Compiler, sourceText: cstring, sourceTextSize: c.size_t, shaderKind: ShaderKind, inputFileName: cstring, entryPointName: cstring, additionalOptions: ^CompileOptions) -> ^CompilationResult ---
