...
foreign lib {
    ...
    */
    ...
    @(link_name="spvc_resources_get_resource_list_for_type")
    _resources_get_resource_list_for_type                 :: proc(resources: Resources, type: resource_type, resource_list: ^[^]reflected_resource, resource_size: ^c.size_t) -> Result ---
...
resources_get_resource_list_for_type :: proc(resources: Resources, type: resource_type) -> (list: []reflected_resource, result: Result) {
    ptr: [^]reflected_resource
    count: c.size_t
    result = _resources_get_resource_list_for_type(resources, type, &ptr, &count)
    list = ptr[:count]
